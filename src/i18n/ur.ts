...
export const ur = {
  ...
  nav: {
    ...
    columns: 'کالم',
    paper: 'اخبار',
    paperToday: 'آج کا اخبار',
    paperPast: 'گزشتہ شمارے',
    gallery: 'گیلری',
    mediaForum: 'انٹرنیشنل میڈیا فورم',
    magazine: 'ماہانہ اقلیتی میگزین',
    team: 'ٹیم',
    articles: 'مضامین',
    about: 'تعارف',
    menu: 'مینو',
  ...
  team: {
    title: 'ہماری ٹیم',
    description: 'روزنامہ عوامی محبت کی ٹیم: ایگزیکٹو بورڈ، مشاورتی بورڈ، رپورٹرز، آئی ٹی و ڈیجیٹل میڈیا اور بین الاقوامی نمائندے۔',
    lead: 'روزنامہ عوامی محبت کی ٹیم پاکستان بھر اور بیرونِ ملک سے ہر روز چار صفحات کا اخبار آپ تک پہنچاتی ہے۔',
    count: (n: number) => `${n} افراد`,
    joinTitle: 'ہمارے ساتھ کام کریں',
    joinBody: 'نمائندگی کے لیے رابطہ صفحے پر اپنی درخواست بھیجیں۔',
    joinCta: 'درخواست دیں',
  },
  contact: {
    title: 'رابطہ',
    ...
    location: 'پتہ',
    mapLabel: 'نقشے پر ہیڈ آفس کا محلِ وقوع',
    ...
    chiefEditor: 'چیف ایڈیٹر',
    bureaus: 'سب آفس',
    bureausNote: 'پاکستان بھر میں ہمارے دفاتر اور نمائندے۔',
    bureausCount: (n: number) => `${n} دفاتر`,
    bureauNo: (n: number) => `آفس #${String(n).padStart(2, '0')}`,
